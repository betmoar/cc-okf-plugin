...
class TestRename(unittest.TestCase):
    ...
    def test_referrer_links_and_index_regenerated(self):
        # §4: rename rewrites body [[old]]->[[new]] and rebuilds index; no links: generated.
        b = make_bundle({
            "old": concept("old", "x"),
        ...
        rename.rename(b, "old", "new")
        ref_text = read(b, "ref")
        self.assertIn("[[new]]", ref_text)
        self.assertNotIn("[[old]]", ref_text)
        self.assertNotIn("links:", ref_text)
